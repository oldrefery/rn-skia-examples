...
interface NeomorphismProps {
  onPress: () => void;
}
export const Neomorphism = ({onPress}: NeomorphismProps) => {
  ...
  return (
    <>
      <Canvas style={styles.flex} onTouch={onTouchSwitch}>
        <Rect x={0} y={0} width={width} height={height}>
          <LinearGradient
            ...
            colors={['white', 'white', 'black', 'black', 'black']}
          />
        </Rect>
        <Button x={x} y={y} width={100} height={100} pressed={pressedButton}>
      ...
      <Pressable onPress={onPress} style={styles.switchButton}>
        <Text style={styles.switchTitle}>Switch</Text>
      </Pressable>
    </>
  );
};
